...
from lset.kernels.fused_loss import (
    fused_dense_loss, should_use_fused, LOSS_MULTI, LOSS_SOFT, LOSS_CROSS,
)
from lset.tasks.losses.contrastive import contrastive_loss
from lset.tasks.losses.fused_contrastive import fused_contrastive_loss
